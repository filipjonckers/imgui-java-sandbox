...
public final class ImGuiGlfwExample {
    ...
    // User UI to render
    private final ImGuiGlfwExampleUi imGuiGlfwExampleUi = new ImGuiGlfwExampleUi();
    ...
    private void setupImGui() {
        ...
        //fontAtlas.addFontFromMemoryTTF(loadFromResources("fonts/basis33.ttf"), 16, fontConfig);
        fontAtlas.addFontFromFileTTF("fonts/monaco.ttf", 14, fontConfig);
        ...
        // fontAtlas.addFontFromFileTTF("fonts/Righteous-Regular.ttf", 14, fontConfig);
        // fontAtlas.addFontFromFileTTF("fonts/Righteous-Regular.ttf", 16, fontConfig);
        ...
        // fontAtlas.addFontFromFileTTF("fonts/Roboto-Regular.ttf", 14, fontConfig);
        ...
        // fontAtlas.addFontFromFileTTF("fonts/Roboto-Regular.ttf", 16, fontConfig);
    ...
    private void startFrame() {
        ...
        glClearColor(imGuiGlfwExampleUi.backgroundColor[0], imGuiGlfwExampleUi.backgroundColor[1], imGuiGlfwExampleUi.backgroundColor[2], 0.0f);
